...
hoge.exe EPOCH FIRST_DERIVATIVE INCLINATION ASCENSION ECCENTRICITY PERIGEE ANOMALY MOTION とコマンドライン引数を入れて実行する
...
******************************************************************************************/
    ...
    now_day += (double)UT->tm_mday + (double)UT->tm_hour /24 + (double)UT->tm_min / 24 / 60 + (double)UT->tm_sec / 24 / 60 / 60; 
